...
Be precise and place labels exactly where the parts are visible in the image. Consider the 3D geometry carefully."""
    ...
    def _is_realistic_intent(self, keywords: str):
        ...
        stylized_hints = {"cartoon", "anime", "stylized", "lowpoly", "low-poly", "toon", "pixar"}
    ...
    def _realism_adjustment(self, keywords: str, title: str = "", tags: list | None = None):
        ...
        stylized_terms = ["cartoon", "anime", "stylized", "toon", "lowpoly", "low-poly", "character"]
        realistic_terms = ["realistic", "photoreal", "scan", "pbr", "animal", "anatomy", "creature"]
...
"""
    ...
    def _search_high_probability_index(self, normalized_keywords: str, limit: int = 6):
        ...
        generic_tokens = {
            "system", "model", "models", "object", "objects", "thing", "items",
            "realistic", "3d", "animated", "animation", "asset", "assets",
        }
        ...
        solar_domain_terms = {"solar", "sun", "planet", "mercury", "venus", "earth", "mars", "jupiter", "saturn", "uranus", "neptune", "orbit"}
            ...
            cards.append(
                {
                    ...
                    "explanation": (
                        f"High-probability indexed model selected for '{normalized_keywords}' "
                        f"from large category prefetch set."
                    ),
    ...
    def _build_realistic_fallback_model(self, normalized_keywords: str, base_score: float = 79.0):
        ...
        card["explanation"] = (
            f"Fallback procedural model for '{normalized_keywords}' with explicit labeled anatomy for reliable learning."
        )
            ...
            if response.status_code == 200:
                ...
                for uid, data in assets.items():
                    ...
                    if match:
                        ...
                        realism_bonus = self._realism_adjustment(" ".join(keywords), data.get("name", ""), data.get("tags", []))
