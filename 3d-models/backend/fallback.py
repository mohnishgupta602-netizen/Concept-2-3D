...
def _concept_part_templates(concept: str):
    ...
    if any(token in query for token in ["solar system", "planet", "sun", "mercury", "venus", "earth", "mars", "jupiter", "saturn", "uranus", "neptune"]):
        return [
            {
                "name": "sun",
                "primitive": "sphere",
                "parameters": {"radius": 1.05, "widthSegments": 28, "heightSegments": 28},
            ...
            },
            {
                "name": "mercury",
                "primitive": "sphere",
                "parameters": {"radius": 0.16, "widthSegments": 18, "heightSegments": 18},
            ...
            },
            {
                "name": "venus",
                "primitive": "sphere",
                "parameters": {"radius": 0.22, "widthSegments": 18, "heightSegments": 18},
            ...
            },
            {
                "name": "earth",
                "primitive": "sphere",
                "parameters": {"radius": 0.24, "widthSegments": 20, "heightSegments": 20},
            ...
            },
            {
                "name": "mars",
                "primitive": "sphere",
                "parameters": {"radius": 0.19, "widthSegments": 18, "heightSegments": 18},
            ...
            },
            {
                "name": "jupiter",
                "primitive": "sphere",
                "parameters": {"radius": 0.48, "widthSegments": 24, "heightSegments": 24},
            ...
            },
            {
                "name": "saturn",
                "primitive": "sphere",
                "parameters": {"radius": 0.42, "widthSegments": 24, "heightSegments": 24},
            ...
            },
            {
                ...
                "primitive": "tube",
                "parameters": {"radiusTop": 0.08, "radiusBottom": 0.08, "height": 2.8, "radialSegments": 24},
