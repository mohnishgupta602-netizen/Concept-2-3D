...
def generate_ml_glb(concept: str, models_dir: str) -> dict[str, Any] | None:
    ...
    if not image_path:
        print(f"[ML] FAILED at image generation step - Stable Diffusion returned no image")
        return None
    ...
    if not mesh_path:
        print(f"[ML] FAILED at OpenLRM step - check OpenLRM repo installation and model download")
        return None
