...
from fallback import generate_fallback, build_fallback_payload
...
def visualize(concept: str):
    ...
    try:
        ...
        print(
            f"[Visualize] Hybrid pipeline timed out after {HYBRID_PIPELINE_TIMEOUT_SECONDS}s "
            f"for concept='{concept}'. Falling back."
        )
        hybrid_result = {
            "type": "generated",
            "model_url": None,
